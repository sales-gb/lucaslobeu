...
export function CtaSection({ headline, sub }: { headline: string; sub: string }) {
  return (
    <section className="relative overflow-hidden bg-ink px-[var(--page-x)] py-[120px] text-paper">
      <div className="flex max-w-[900px] flex-col gap-7">
        <SectionMarker tone="light">Próximo passo</SectionMarker>
        <TextReveal
          text={headline}
          as="h2"
          className="font-serif font-light italic text-[clamp(52px,8vw,128px)] leading-[0.92] tracking-[-0.03em] text-paper"
          stagger={0.055}
          delay={60}
        />
        <Reveal y={20} delay={200}>
          <p className="max-w-[480px] font-sans font-light text-[clamp(16px,1.8vw,20px)] leading-[1.6] text-paper/60">
            {sub}
          </p>
        </Reveal>
